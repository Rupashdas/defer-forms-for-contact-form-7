/**
 * CF7 Nova — the two things every front-end script here needed.
 *
 ...
 *
 * This is a dependency of every other cf7nl script, so it is on the page before
 * any of them run.
 */
( function () {
	'use strict';

	var cf7nl = window.cf7nl || ( window.cf7nl = {} );
	...
	/**
	 * Hand every Nova-rendered form to a callback, now and later.
	 *
	 ...
	 */
	cf7nl.forms = function ( fn ) {
		cf7nl.ready( function () {
	 ...
	 */
	cf7nl.onReset = function ( form, fn ) {
	 ...
	 * settings.
	 */
	cf7nl.el = function ( tag, className, text ) {
